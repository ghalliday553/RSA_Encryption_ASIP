...
int main(void) {
	...
	*/
	...
	stringToBinary("44060415993956535756752637649392701399", binaryBuf1);
	stringToBinary("44060415993956535756752637649392701399", binaryBuf2);
	stringToBinary("120946452853127629758136486859378571097", binaryBuf3);
	montgomeryMultiplicationHelper(binaryBuf1, binaryBuf2, binaryBuf3, binaryBuf4);
	printf("44060415993956535756752637649392701399*44060415993956535756752637649392701399 mod 120946452853127629758136486859378571097 is ");
	printArr(binaryBuf4);
	// correct: 493daff4b0f4af1257996264b1d174dd
